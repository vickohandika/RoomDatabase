...
public class AdapterBarangRecyclerView extends RecyclerView.Adapter<AdapterBarangRecyclerView.ViewHolder> {
    ...
    @NonNull
    @Override
    public AdapterBarangRecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        /** * Inisiasi ViewHolder */
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterBarangRecyclerView.ViewHolder holder, final int position) {
...
////                Barang barang = db.barangDAO().seletBarangDetail(daftarBarang.get(position).getBarangId());
////                context.startActivity(Read.getActIntent((Activity) context).putExtra("data", barang));
            }
        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        /** * Inisiasi View * Di tutorial ini kita hanya menggunakan data String untuk tiap item * dan juga view nya hanyalah satu TextView */
        TextView tvTitle;
        CardView cvMain;
